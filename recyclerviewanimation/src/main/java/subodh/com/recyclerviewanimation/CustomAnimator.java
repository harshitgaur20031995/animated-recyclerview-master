package subodh.com.recyclerviewanimation;
...
public class CustomAnimator {
    ...
    private AnimationListner springAnimatorListener;
    private int delay = 0;
    ...
    public CustomAnimator(AnimationType type, double tension,
     ...
     * @param  endValue where animation ends to
     * **/
      public CustomAnimator(AnimationType type, float startValue,
                            float endValue) {
...
* */
    public void setSpringyListener(AnimationListner animationListner) {
        this.springAnimatorListener = animationListner;
    }
