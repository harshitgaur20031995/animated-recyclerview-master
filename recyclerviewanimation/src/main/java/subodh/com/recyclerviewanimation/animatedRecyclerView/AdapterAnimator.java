package subodh.com.recyclerviewanimation.animatedRecyclerView;
...
public class AdapterAnimator {
    ...
    private AdapterCustomAnimationType animationType;
    private boolean mFirstViewInit = true;
    private int mLastPosition = -1;
    private int mStartDelay;

    public AdapterAnimator(RecyclerView recyclerView) {
        parent = recyclerView;
        mSpringSystem = SpringSystem.create();
        animationType = AdapterCustomAnimationType.SLIDE_FROM_BOTTOM;
...
* */
    ...
    public void setSpringAnimationType(AdapterCustomAnimationType type){
        animationType = type;
    }
